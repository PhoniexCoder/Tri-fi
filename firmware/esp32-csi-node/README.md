...
| `pres_thresh` | u16 | *auto* | Presence threshold (x1000). 0 = auto-calibrate from 8 s ambient |
...
| Vitals readings unstable | Calibration period | Wait 8 seconds for adaptive threshold to settle |
