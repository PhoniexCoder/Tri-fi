...
Real-time sensing applications built on the Trifi platform.
...
|---------|---------|-------------|
| [**trifi_live.py**](trifi_live.py) | CSI + mmWave + Light | Unified dashboard: HR, BR, BP, stress, presence, light, RSSI |
...
# CSI only (no mmWave)
python examples/trifi_live.py --csi COM7 --mmwave none
```
